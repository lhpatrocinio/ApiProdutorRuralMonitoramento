...
/// <summary>
/// Validador para atualização de regra de alerta
/// </summary>
public class RegraAlertaUpdateRequestValidator : AbstractValidator<RegraAlertaUpdateRequest>
{
    public RegraAlertaUpdateRequestValidator()
    {
        RuleFor(x => x.Nome)
            .NotEmpty()
